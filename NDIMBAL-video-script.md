...
**Primary length: ~1 min 45** (tight beats long — the jury watches many entries).
**Audience:** someone who has *never heard of FHE*. Lead with the human idea, not the cryptography.
**Two things that win this bounty, both on screen:** *private generosity* (only FHE makes it possible) **and**
*real yield* (the prize funds itself from a confidential DeFi strategy — not a sponsor). Land the first in the
opening seconds; land the second as the "this is a product, not a demo" beat.
**Tone:** warm, confident, concrete. Everything on screen is the *live* dApp doing *real* on-chain things.
...
**Voiceover:**
> "Deployed and source-verified on Sepolia — every action was a real transaction you can inspect. NDIMBAL: no-loss savings, a prize funded by real yield, and quiet solidarity — confidential end to end, on Zama fhEVM."
...
4. ★ Real yield: Route → Earn → Harvest (prize funds itself)  ← **the "product" money shot**
5. Solidarity slider → Tanti caché inputs  ← **the emotional money shot; hold on it**
6. Run draw → Authorize → decrypt "Did I win? = 1" → decrypt balance (intact)
...
- "The prize funds itself — real yield, not a sponsor"  ·  "Tanti caché — private generosity, only possible with FHE"
- "Only the winner can decrypt"  ·  "Deployed & source-verified"
